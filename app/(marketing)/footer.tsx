    ...
    return (
        <footer className="hidden lg:block h-20 w-full border-t-2 border-slate-200 p-2">
            <div className="max-w-screen-lg mx-auto flex items-center justify-evenly h-full">
                <Button size="lg" variant="guost" className="w-full">
                    <Image src="/hr.svg" alt="Croatian flag" height={32} width={40} className="mr-4 rounded-md"/>
                    Croatian
                </Button>

                <Button size="lg" variant="guost" className="w-full">
                    <Image src="/es.svg" alt="Croatian flag" height={32} width={40} className="mr-4 rounded-md"/>
                    Spanish
                </Button>
                <Button size="lg" variant="guost" className="w-full">
                    <Image src="/fr.svg" alt="Frence flag" height={32} width={40} className="mr-4 rounded-md"/>
                    French
                </Button>
                <Button size="lg" variant="guost" className="w-full">
